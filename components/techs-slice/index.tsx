...
const TechsSlice = () => {
  return (
    <div className='flex flex-wrap items-center justify-center gap-6 flex-w'>
      ...
      <SiTypescript className='w-12 h-12 text-[#3178C6] hover:scale-110 transition-transform duration-300' />
      <SiNextdotjs className='w-12 h-12 text-black transition-transform duration-300 dark:text-white hover:scale-110' />
      <SiNestjs className='w-12 h-12 text-[#E0234E] hover:scale-110 transition-transform duration-300' />
      ...
      <SiCss className='w-12 h-12 text-[#1572B6] hover:scale-110 transition-transform duration-300' />
      <SiTailwindcss className='w-12 h-12 text-[#06B6D4] hover:scale-110 transition-transform duration-300' />
      <SiPostgresql className='w-12 h-12 text-[#336791] hover:scale-110 transition-transform duration-300' />
      <SiPrisma className='w-12 h-12 text-[#5A67D8] hover:scale-110 transition-transform duration-300' />
      <SiSupabase className='w-12 h-12 text-[#3ECF8E] hover:scale-110 transition-transform duration-300' />
      ...
      <SiTurborepo className='w-12 h-12 text-[#EF4444] hover:scale-110 transition-transform duration-300' />
      ...
      <SiGit className='w-12 h-12 text-[#F05032] hover:scale-110 transition-transform duration-300' />
      <FaAws className='w-12 h-12 text-[#FF9900] hover:scale-110 transition-transform duration-300' />
    </div>
  )
}
